...
setup(
    ...
    description="This tool clusterizes lines of text given a collection of input patterns modeled using regular expressions.",
    entry_points={
        'console_scripts': [
    ...
    url='https://github.com/ibgp2/pattern_clustering',
    version='0.1.0',
    zip_safe=False,
)
